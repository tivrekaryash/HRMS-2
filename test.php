            ...
            <section class="content">
                <div class="container-fluid p-3">
                    ...
                    <ul class="nav nav-tabs" id="hisTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link <?php if ($count == 1) echo "active"; ?>" id="leaves-tab" data-toggle="tab" href="#leaves" role="tab" aria-controls="leaves" aria-selected="<?php if ($count == 2) echo "true";
                    ...
                    <div class="tab-content">
                        ...
                        <!-- leaves -->
                        <div class="tab-pane fade <?php if ($count == 1) echo "show active"; ?>" id="leaves" role="tabpanel" aria-labelledby="leaves-tab">
                            <button type="button" data-toggle="modal" data-target="#modal_clock_in" class="btn btn-outline-success" style="float:right">
                                <i class="fas fa-stopwatch"></i> Clock-in
                    ...
                    <!-- modal_clock_in -->
                    <div class="modal fade" id="modal_clock_in" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

                ...
                <div class="container-fluid p-3">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade <?php if ($count == 4) echo "show active"; ?>" id="leaverec" role="tabpanel" aria-labelledby="leaverec-tab">
                            ...
                            // retrieves all leaves records
                            $result = $conn->query("SELECT leave_id, employee_id, type_id, max(leave_start_date) as leave_start_date, max(leave_end_date) as leave_end_date, reason, approval FROM leaves where approval='approved' group by leave_start_date");

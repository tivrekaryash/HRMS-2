...
$res = mysqli_query($conn, "INSERT INTO candidate_information (candidate_fullname, candidate_dob, candidate_age, candidate_gender, candidate_address, phnum, candidate_email, experience_in_years) values ('$fullname', '$dateofbirth', '$age', '$gender', '$address', '$phnumber', '$email', '$wexp')");
